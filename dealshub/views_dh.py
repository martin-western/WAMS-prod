...
class SendB2BOTPSMSLoginAPI(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if contact_number in ["888888888","777777777","777777788", "940804016", "888888881", "702290032", "888888883", "888888884"]:
                OTP = "777777"
...
class SendOTPSMSLoginAPI(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if contact_number in ["88888888", "888888888","777777777","777777788", "940804016", "888888881", "702290032"]:
                OTP = "777777"
        ...
        try:
            ...
            if dealshub_user_obj.verification_code==otp:
                ...
                if otp_attempts >= 5:
                    ...
                    if contact_number in ["88888888", "888888888","777777777","777777788","888888884", "940804016", "888888881", "702290032"]:
                        OTP = "777777"
