...
class B2BUser(DealsHubUser):
    ...
    vat_certificate_images = models.ManyToManyField(Image, blank=True)
    trade_license_images = models.ManyToManyField(Image, blank=True)
    passport_copy_images = models.ManyToManyField(Image, blank=True)
