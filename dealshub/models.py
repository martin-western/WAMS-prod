...
class B2BUser(DealsHubUser):
    ...
    vat_certificate_image = models.ManyToManyField(Image, blank=True)
    trade_license_image = models.ManyToManyField(Image, blank=True)
    passport_copy_image = models.ManyToManyField(Image, blank=True)
