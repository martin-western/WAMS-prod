...
def generate_xml_for_post_product_data_amazon_uk(product_pk_list,seller_id,partial=False):
    try:
         # Check if Cached
        ...
        logger.error("Generating XML for Post Product Data UK: %s at %s", e, str(exc_tb.tb_lineno))
        return ""
