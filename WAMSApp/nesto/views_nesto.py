        ...
        try:
            ...
            for i in range(rows):
                try:
                    ...
                    primary_keywords = [] if str(dfs.iloc[i][17]).strip()=="nan" else str(dfs.iloc[i][17]).strip()
                    secondary_keywords = [] if str(dfs.iloc[i][18]).strip()=="nan" else str(dfs.iloc[i][18]).strip()
                    try:
