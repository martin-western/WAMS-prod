...
urlpatterns = [
    ...
    url(r'^fetch-factory-for-sourcing-user/$',views.FetchFactoryForSourcingUser),
    url(r'^fetch-factories-for-sourcing-user/$',views.FetchFactoriesForSourcingUser),
    ...
    url(r'^fetch-shared-products-for-factory/$',views.FetchSharedProductsForFactory),
    ...
    url(r'^save-sourcing-product-details/$',views.SaveSourcingProductDetails),
    url(r'^save-sourcing-factory-details/$', views.SaveSourcingFactoryDetails),
    url(r'^fetch-factorywise-product-listing/$',views.FetchFactorywiseProductListing),
    url(r'^fetch-factory-product-details/$', views.FetchFactoryProductDetails),
    url(r'^fetch-sourcing-product-details/$',views.FetchSourcingProductDetails),
    ...
    url(r'^upload-factories-and-products-sourcing-users/$',views.UploadFactoriesProductsFromSourcing),
    url(r'^upload-sourcing-user-product-image/$',views.UploadSourcingProductProductImage),
