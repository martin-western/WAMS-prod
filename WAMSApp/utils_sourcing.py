...
def generate_pi(factory_code, invoice_details, product_list):
    ...
    port_of_loading = factory_obj.loading_port
    port_of_discharge = invoice_details["discharge_port"]
    ...
    bank_name = factory_obj.bank.name
    account_number = factory_obj.bank.account_number
    ifsc_code = factory_obj.bank.ifsc_code
    swift_code = factory_obj.bank.swift_code
    branch_code = factory_obj.bank.branch_code
    bank_address = factory_obj.bank.address
        ...
        product_html_string += """
            ...
            <div class="product-table-body">
                ...
                <div class="product-table-head-amount-container center-element">
                  <p class="product-table-head-text">
                    """+str(round(sourcing_product_obj.price*int(product["quantity"]), 2))+"""
                  </p>
                </div>
              </div>
        """
    ...
    pdfkit.from_string(html_string, str(invoice_number)+'.pdf')
