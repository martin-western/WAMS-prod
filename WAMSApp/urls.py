...
urlpatterns = [
    ...
    url(r'^admin/fetch-super-categories/$', views.FetchAdminSuperCategories),
    url(r'^admin/fetch-categories/$', views.FetchAdminCategories),
    url(r'^admin/fetch-sub-categories/$', views.FetchAdminSubCategories),
    url(r'^admin/update-super-category-details/$', views.UpdateAdminSuperCategoryDetails),
    url(r'^admin/update-category-details/$', views.UpdateAdminCategoryDetails),
    url(r'^admin/update-sub-category-details/$', views.UpdateAdminSubCategoryDetails),
    url(r'^admin/add-new-super-category/$', views.AddNewAdminSuperCategory),
    url(r'^admin/add-new-category/$', views.AddNewAdminCategory),
    url(r'^admin/add-new-sub-category/$', views.AddNewAdminSubCategory),
